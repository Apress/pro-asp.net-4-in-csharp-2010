...
<body>
    ...
    <div>
        ...
        runat="server" UpdateCommand="UPDATE Shippers SET CompanyName=@CompanyName, Phone=@Phone WHERE ShipperID=@original_ShipperID AND CompanyName=@original_CompanyName AND Phone=@original_Phone" 
        ...
        <asp:DetailsView ID="detailsConflicting" runat="server" Height="50px" Width="365px" AutoGenerateRows="False" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataKeyNames="ShipperID" DataSourceID="sourceUpdateValues" Font-Names="Verdana" Font-Size="Small">
            <FooterStyle BackColor="#FFFFCC" ForeColor="#330099" />
            <RowStyle BackColor="White" ForeColor="#330099" />
            <PagerStyle BackColor="#FFFFCC" ForeColor="#330099" HorizontalAlign="Center" />
            <Fields>
