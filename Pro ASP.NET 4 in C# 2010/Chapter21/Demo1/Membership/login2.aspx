...
<body>
    ...
    <div style="text-align: center">
        <asp:Login ID="LoginCtrl" runat="server" 
                   ...
                   PasswordRecoveryUrl="~/pwdrecover.aspx" OnAuthenticate="LoginCtrl_Authenticate" OnLoggingIn="LoginCtrl_LoggingIn">
            <LayoutTemplate>
        ...
        <asp:Login ID="OtherLoginCtrl" runat="server"
            ...
            <LayoutTemplate>
                ...
                <asp:Button runat="server" ID="Login1" CommandName="Login1" Text="Login" />
                </font>
            </LayoutTemplate>
