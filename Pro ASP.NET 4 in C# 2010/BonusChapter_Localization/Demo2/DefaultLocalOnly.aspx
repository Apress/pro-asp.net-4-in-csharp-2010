<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DefaultLocalOnly.aspx.cs"
    Inherits="Default_aspx" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
...
<asp:RegularExpressionValidator ControlToValidate="BirthdateText" ErrorMessage="Invalid date!!"
    ID="RegularExpressionValidator1" runat="server" ValidationExpression='<%$ Resources:RegularExpressionValidatorResource1.DateFormat %>'
    meta:resourcekey="RegularExpressionValidatorResource1"></asp:RegularExpressionValidator>
            ...
            <tr>
                <td style="width: 314px">
                    ...
                    (Format:
                    <asp:Label ID="SalaryFormat" runat="server" />)
                </td>
                <td>
...
<asp:RegularExpressionValidator ControlToValidate="SalaryText" ErrorMessage="Invalid salary!!"
    ID="RegularExpressionValidator2" runat="server" ValidationExpression='<%$ Resources: RegularExpressionValidatorResource2.SalaryFormat %>'
    ...
    <asp:Label ID="ExplicitGlobalTest" meta:resourcekey="LabelResource6" runat="server"
        Text="<%$ Resources: RegularExpressionValidatorResource1.DateFormat %>"></asp:Label>
    <br />
    <br />
    <asp:Localize runat="server" ID="TestLocalizeControl" meta:resourcekey="LiteralResource1">This is some static text!</asp:Localize>
    </form>
</body>
</html>
