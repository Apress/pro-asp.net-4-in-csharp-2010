...
<body>
    <form id="form1" runat="server">
   	    <div style="BORDER-RIGHT: 1px ridge; PADDING-RIGHT: 10px; BORDER-TOP: 1px ridge; PADDING-LEFT: 10px; FONT-SIZE: x-small; PADDING-BOTTOM: 10px; MARGIN: 10px; BORDER-LEFT: 1px ridge; WIDTH: 298px; PADDING-TOP: 10px; BORDER-BOTTOM: 1px ridge; FONT-FAMILY: Verdana; BACKGROUND-COLOR: #F5F5DC"
		...
		<div visible="false" style="BORDER-RIGHT: 1px ridge; PADDING-RIGHT: 10px; BORDER-TOP: 1px ridge; PADDING-LEFT: 10px; FONT-SIZE: x-small; PADDING-BOTTOM: 10px; MARGIN: 10px; BORDER-LEFT: 1px ridge; WIDTH: 298px; PADDING-TOP: 10px; BORDER-BOTTOM: 1px ridge; FONT-FAMILY: Verdana; BACKGROUND-COLOR: #F5F5DC"
		...
		<div visible="false" style="BORDER-RIGHT: 1px ridge; PADDING-RIGHT: 10px; BORDER-TOP: 1px ridge; PADDING-LEFT: 10px; FONT-SIZE: x-small; PADDING-BOTTOM: 10px; MARGIN: 10px; BORDER-LEFT: 1px ridge; WIDTH: 298px; PADDING-TOP: 10px; BORDER-BOTTOM: 1px ridge; FONT-FAMILY: Verdana; BACKGROUND-COLOR: #F5F5DC"
			...
			<br /><br />
			<asp:Label id="Label4" runat="server" EnableViewState="False" Font-Italic="True">Panel with custom content</asp:Label>
		</div>
    </form>
</body>
</html>
